...
%prep
%setup -q -n gnuplot-5.4.3
cd %{_builddir}/gnuplot-5.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642779052
...
cp %{_builddir}/gnuplot-5.4.3/config/MacOSX/PkgResources/License.rtf %{buildroot}/usr/share/package-licenses/gnuplot/ec56950fb609cf315c739166cf0ce4b80f4bf4d4
%make_install
