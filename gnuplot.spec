...
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/6.0.2/gnuplot-6.0.2.tar.gz
...
%prep
%setup -q -n gnuplot-6.0.2
cd %{_builddir}/gnuplot-6.0.2
pushd ..
cp -a gnuplot-6.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744137101
