...
Version  : 5.4.2
Release  : 31
URL      : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.2/gnuplot-5.4.2.tar.gz
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.2/gnuplot-5.4.2.tar.gz
...
%prep
%setup -q -n gnuplot-5.4.2
cd %{_builddir}/gnuplot-5.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623077715
...
cp %{_builddir}/gnuplot-5.4.2/Copyright %{buildroot}/usr/share/package-licenses/gnuplot/414913c1ed698f7c8f0a08c0e5d447c8bd0d66f4
cp %{_builddir}/gnuplot-5.4.2/config/MacOSX/PkgResources/License.rtf %{buildroot}/usr/share/package-licenses/gnuplot/ec56950fb609cf315c739166cf0ce4b80f4bf4d4
%make_install
