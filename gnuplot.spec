...
Version  : 5.0.5
Release  : 5
URL      : http://downloads.sourceforge.net/project/gnuplot/gnuplot/5.0.5/gnuplot-5.0.5.tar.gz
Source0  : http://downloads.sourceforge.net/project/gnuplot/gnuplot/5.0.5/gnuplot-5.0.5.tar.gz
...
%prep
%setup -q -n gnuplot-5.0.5

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489895023
