...
Version  : 5.2.8
Release  : 24
URL      : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.2.8/gnuplot-5.2.8.tar.gz
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.2.8/gnuplot-5.2.8.tar.gz
...
%prep
%setup -q -n gnuplot-5.2.8
cd %{_builddir}/gnuplot-5.2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575399345
...
cp %{_builddir}/gnuplot-5.2.8/Copyright %{buildroot}/usr/share/package-licenses/gnuplot/414913c1ed698f7c8f0a08c0e5d447c8bd0d66f4
cp %{_builddir}/gnuplot-5.2.8/config/MacOSX/PkgResources/License.rtf %{buildroot}/usr/share/package-licenses/gnuplot/ec56950fb609cf315c739166cf0ce4b80f4bf4d4
%make_install
