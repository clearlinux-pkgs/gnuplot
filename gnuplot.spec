...
Version  : 5.4.5
Release  : 37
URL      : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.5/gnuplot-5.4.5.tar.gz
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.5/gnuplot-5.4.5.tar.gz
...
%prep
%setup -q -n gnuplot-5.4.5
cd %{_builddir}/gnuplot-5.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664940579
