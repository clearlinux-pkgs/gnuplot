...
Version  : 5.4.6
Release  : 38
URL      : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.6/gnuplot-5.4.6.tar.gz
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/5.4.6/gnuplot-5.4.6.tar.gz
...
%prep
%setup -q -n gnuplot-5.4.6
cd %{_builddir}/gnuplot-5.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676246673
