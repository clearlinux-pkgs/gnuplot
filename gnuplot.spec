...
Source0  : https://sourceforge.net/projects/gnuplot/files/gnuplot/6.0.1/gnuplot-6.0.1.tar.gz
...
%prep
%setup -q -n gnuplot-6.0.1
cd %{_builddir}/gnuplot-6.0.1
pushd ..
cp -a gnuplot-6.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717019278
